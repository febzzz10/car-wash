...
import { staffLookupRoutes } from "./routes/staff-lookup";
import { uploadRoutes } from "./routes/uploads";
import { userRoutes } from "./routes/users";
import { vehicleMakeRoutes } from "./routes/vehicle-makes";
...
protectedApi.route("/staff", staffLookupRoutes);
protectedApi.route("/uploads", uploadRoutes);
protectedApi.route("/users", userRoutes);
protectedApi.route("/vehicle-makes", vehicleMakeRoutes);
